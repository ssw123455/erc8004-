...
import "../src/v1/IdentityRegistry.sol";
import "../src/v1/ReputationRegistry.sol";
import "../src/v1/ValidationRegistry.sol";
...
contract DeployV1 is Script {
    ...
    function run() external {
        ...
        console.log("forge verify-contract <address> src/v1/IdentityRegistry.sol:IdentityRegistry");
        console.log("forge verify-contract <address> src/v1/ReputationRegistry.sol:ReputationRegistry --constructor-args <encoded>");
        console.log("forge verify-contract <address> src/v1/ValidationRegistry.sol:ValidationRegistry --constructor-args <encoded>");
    }
}
